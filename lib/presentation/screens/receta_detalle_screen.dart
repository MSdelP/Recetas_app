...
// Añadir al historial solo una vez tras crear el frame
...
if (receta.autor.isNotEmpty)
Text('Autor: ${receta.autor}'),
if (receta.calorias > 0)
Text('Calorías: ${receta.calorias} kcal'),
Text('Creada en: ${receta.creadaEn.toLocal().toString().split(' ')[0]}'),
],
),
),
);
